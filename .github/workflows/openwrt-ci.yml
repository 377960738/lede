    ...
    steps:
      ...
      - name: Generate configuration file
        run: |
          ...
          # CONFIG_TARGET_ipq40xx_DEVICE_glinet_gl-a1300 is not set
          ...
          CONFIG_FEED_PWpackages=y
          CONFIG_FEED_PWluci=y
          CONFIG_FEED_infinityfreedom=y
